...
from llava.constants import DEFAULT_IM_START_TOKEN, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_END_TOKEN, IMAGE_TOKEN_INDEX, DEFAULT_VID_START_TOKEN, DEFAULT_VID_END_TOKEN
...
def get_model_output(model, video_processor, tokenizer, video, qs, args):
    ...
    video_tensor = video_processor(video, return_tensors='pt')['pixel_values'].to(args.device).half()
