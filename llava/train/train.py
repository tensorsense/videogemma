...
from llava.constants import DEFAULT_VIDEO_TOKEN, DEFAULT_VID_START_TOKEN, DEFAULT_VID_END_TOKEN, MAX_IMAGE_LENGTH, MAX_VIDEO_LENGTH
...
from llava.utils import order_pick_k
...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        # this would mean that after some samples are deleted, some other samples would be used multiple times
        ...
        if 'video' in sources[0]:
            ...
            try:
                ...
                print(f'Bad sample #{i} {video_file}, finding new one.')
